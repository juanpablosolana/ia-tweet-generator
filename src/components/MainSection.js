      ...
      <div className='grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12'>
        <div className='mr-auto place-self-center lg:col-span-7'>
          ...
          <p className='max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400'>
            Tweet Generator is a project to generate artificially intelligent tweets. <br />
            Uses natural language processing and deep learning algorithms to generate tweets that are similar to what humans would write. <br />
            Is currently in early stages of development, but it is a promising start for automated tweet generation.
          </p>
          {
            isLoding
              ? <Loader />
        ...
        <div className='py-2 lg:mt-0 lg:col-span-5 lg:flex items-center flex-col gap-4'>
          {
            isLoding
              ? <ImageSkeletor />
              : <Image src={imgGenerator} width={400} height={400} alt='Image create by AI' className='rounded-lg' priority />
          }
          {
            isLoding
              ? <TextSkeletor />
              : <p className='font-semibold text-gray-500 dark:text-gray-400'>{message}</p>
          }
          {
